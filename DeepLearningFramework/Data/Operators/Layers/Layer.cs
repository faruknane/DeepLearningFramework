...
//        public virtual Dimension BatchSize { get; internal set; }
...
//                {
//                    EmptyVariable = new Terms.Variable(D1, BatchSize) { Trainable = false };
//                    EmptyVariable.Weights.SetZero();
//                }
//                else if(EmptyVariable.D1 != D1 || EmptyVariable.D2 != BatchSize)
//                {
//                    EmptyVariable.Clean();
//                    EmptyVariable = new Terms.Variable(D1, BatchSize) { Trainable = false };
//                    EmptyVariable.Weights.SetZero();
